                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center pt-3 border-top">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a href="download_pdf.php?pnr=<?= htmlspecialchars($booking['pnr']); ?>" class="btn btn-danger rounded-pill px-4 fw-bold shadow-sm">
                                <i class="bi bi-file-earmark-pdf-fill me-1"></i> Download Ticket PDF
                            </a>
